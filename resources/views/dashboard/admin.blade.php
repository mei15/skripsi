        ...
        <div class="col-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">Dashboard Admin {{$user->full_name}}</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data['totalMahasiswa'] }} Mahasiswa</td>
                                <td><a href='{{ route("mahasiswa.index") }}'><i class='ti ti-eye'></i> Lihat</a></td>
                            </tr>
                            <tr>
                                <td>Total Admin</td>
                                <td>{{ $data['totalAdmin'] }} Admin</td>
                                <td><a href='{{ route("admin.index") }}'><i class='ti ti-eye'></i> Lihat</a></td>
                            </tr>
                            <tr>
